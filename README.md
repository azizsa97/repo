...
git clone https://github.com/azizsa97/repo/superflux-bot.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf azizsa97 && rm -rf .telegram-cli && git clone https://github.com/azizsa97/repo/superflux-bot.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
